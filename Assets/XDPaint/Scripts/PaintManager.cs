...
namespace XDPaint
{
    public class PaintManager : MonoBehaviour, IPaintManager
    {
        ...
        public void TestPaintTrigger(int buttonStatus)
        {
            if (buttonStatus == 1)
            {
                //PaintObject.OnMouse(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)), null, true);
                if (inputData != null)
                inputData.OnEyeTrackingDown(0, Input.mousePosition);
               // PaintObject.EyeTrackingOnMouse(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)), null, true);
                //currentBrush.Init(PaintMode);
                //toolsManager.CurrentTool.OnBrushChanged(currentBrush);
            }
            ...
            if (buttonStatus == 2)
            {
                inputData.OnEyeTrackingPress(0, Input.mousePosition);
                //PaintObject.EyeTrackingOnMouse(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)), null, false);
                //PaintObject.OnMouse(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)), null, false);
            }

            if(buttonStatus == 0)
            {
                inputData.OnEyeTrackingUp(0, Input.mousePosition, true);
                //PaintObject.OnEyeTrackingMouseUp(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)));
                //currentBrush.Init(PaintMode);
                //toolsManager.CurrentTool.OnBrushChanged(currentBrush);
                //PaintObject.OnMouseUp(inputData.InputDataHistory[0].UpdateFrameData(data => data.Update(inputData.GetRay(Input.mousePosition), Input.mousePosition)));
